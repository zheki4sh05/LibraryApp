...
class BookControllerTest extends AbstractIntegrationTest {
    ...
    public void fetch_with_and_without_params_200(){
        ...
        var books = List.of(
          new Book("book1", "621.391.83", UUID.fromString(currentAuthorDto.getId())),
          new Book("book2", "621.391.83", UUID.fromString(currentAuthorDto.getId())),
          new Book("book3", "621.391.83", UUID.fromString(currentAuthorDto.getId())),
          new Book("book4", "621.391.83", UUID.fromString(currentAuthorDto.getId()))
        );
    ...
    public void update_existed_book_200(){
      ...
      BookDto updatedBook = new BookDto(bookDto.id(), "new name", "821.111", bookDto.author());
        ...
        var bookMono = bookRepository.findById(UUID.fromString(updatedBook.id()));
    ...
    var bookMono = bookRepository.findById(UUID.fromString(bookId));
